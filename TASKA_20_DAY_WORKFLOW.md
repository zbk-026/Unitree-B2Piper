...
- Final verification: local `main` is clean and tracks `origin/main`; remote `main` is synchronized with local `HEAD`, and all reachable commits use the owner's identity.
